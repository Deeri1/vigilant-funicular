...
local loadtime = game:GetService("Players").RespawnTime --anti respawn delay
...
local function align(Part0, Part1)
    ...
    if alignmode == 4 then
        ...
        if Part0 == healthHide then
            healthHide = false
            tdelay(0, function()
                while twait(.001) and Part0 and c do
...
--script here
print("scriptreset")
char.HumanoidRootPart.CFrame = choosencf --needed
wait(.25)
