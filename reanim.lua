...
wait(.4)
lol = Character.HumanoidRootPart:FindFirstChild("RootJoint")
if lol then
...
ResetBindable.Event:Connect(function()
	   ...
	   killing = true
	  game.Players.LocalPlayer.Character.Parent.Humanoid.BreakJointsOnDeath = true
	game:FindFirstChildOfClass("Players").LocalPlayer.Character = game.Players.LocalPlayer.Character.Parent
...
coroutine.wrap(destroyall)()
end
function r6reanimatesimple()
    local player = game:GetService("Players").LocalPlayer.Character
local aligns = {}
local hataligns = {}
function fgvbhnjmi(number)
...
if _G.r6reanim == true then
    coroutine.wrap(r6reanimatesimple)()
end
if _G.r6reanimold == true then
